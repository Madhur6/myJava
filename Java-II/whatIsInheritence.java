...
// 1). Single-Level Inheritence Example----------------------------------*--------------------------------------------------*----------
...
class Car {
    ...
    public String toString(){
        return "****** Car name: " + this.modelName + "| Car price: " + this.price + "| Car launch year: " + this.year + "| Car color: " + this.myColor + "  |  ****"; 
        
        // Since we're overriding it, We are going to return whatever we want from this method called "toString()".
    }
}
...
// 3). Heirarchial Inheritence Example----------------------------------*--------------------------------------------------*----------
...
// 4. hybrid: combination of any two or three...
...
// 5. multiple: Doesn't exist in java... [we will go over this later...]
