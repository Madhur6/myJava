...
// Normal version 
interface Payments {
    void processPayment(long credit_number, double amount);
}

abstract class onlinePayment implements Payments {
    public boolean authenticatePayment(long credit_number){
        System.out.println("Authenticating payment in onlinePayment class.");
        return true;
    }
}
...
class creditCardPayment extends onlinePayment {
    ...
    public void processPayment(long credit_number, double amount) {
        boolean res = authenticatePayment(credit_number);
        if (res){
            System.out.println("The payment of $" + amount + " is now successful!");
        } else {
...
// abstract class onlinePayment implements Payments {
//     abstract boolean authenticatePayment(long credit_number);
// }
...
public class interfaceEx {
    public static void main(String[] args){
        ...
        long credit_number = 378282246310005L;
        double amount = 250.75;
        ccp.processPayment(credit_number, amount);
    }
}